...
export async function getPlaygroundContext(
  ...
  return apiClient.get<PromptPlaygroundContext>(`/api/v2/admin/ai-agents/${agentId}/playground${qs}`)
}
...
export async function dryRunPromptTest(
  ...
  assertEnabled()
  return apiClient.post<PromptDryRunResult>(`/api/v2/admin/ai-agents/${agentId}/playground/dry-run`, payload)
}
...
export async function runPromptTest(
  ...
  assertEnabled()
  return apiClient.post<PromptActualTestResult>(`/api/v2/admin/ai-agents/${agentId}/playground/run`, payload)
}
