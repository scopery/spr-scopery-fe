...
import { TEMPLATE_ENDPOINTS, ADMIN_ENDPOINTS } from '@/constants/endpoints'
  ...
  if (res && typeof res === 'object') {
    if ('data' in res && res.data && typeof res.data === 'object') {
      ...
      return {
        ...
        page: (d.page && typeof d.page === 'object' ? d.page : { limit: 100, offset: 0, total: 0 }) as TemplateListResponse['page'],
      }
    }
...
function unwrapTemplate(res: unknown): TemplateListItem {
  if (res && typeof res === 'object') {
    ...
    if ('data' in res && res.data && typeof res.data === 'object') return res.data as TemplateListItem
  }
