...
export async function updateAgent(agentId: string, payload: UpdateAIAgentPayload): Promise<AIAgentDetail> {
  assertEnabled()
...
export async function getAgentVersion(agentId: string, versionId: string): Promise<AIAgentVersionDetail> {
  assertEnabled()
...
export async function publishAgentVersion(agentId: string, versionId: string): Promise<AIAgentVersionDetail> {
  assertEnabled()
  return apiClient.post<AIAgentVersionDetail>(
...
export async function archiveAgentVersion(agentId: string, versionId: string): Promise<AIAgentVersionDetail> {
  assertEnabled()
  return apiClient.post<AIAgentVersionDetail>(
