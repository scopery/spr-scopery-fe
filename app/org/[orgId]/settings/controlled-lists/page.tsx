...
import { Box, Button, Input, Typography, Stack, Select, Badge, Modal, ContentLoader, Textarea } from '@/shared/ui'
import { ROUTES } from '@/constants/routes'
import { useProjects } from '@/hooks/useProjects'
import { useControlledLists } from '@/hooks'
...
export default function OrgControlledListsPage() {
  ...
  const handleCreateSubmit = useCallback(async () => {
    ...
    try {
      ...
      const msg =
        e instanceof Error ? e.message : 'Failed to create controlled list'
      toast.error(msg)
          ...
          {createListKey.trim() && (
            <Typography variant="small" tone="muted">
              ...
              <span className="font-mono">
                {normalizeListKey(createListKey)}
              </span>
            </Typography>
          )}
          <Input
