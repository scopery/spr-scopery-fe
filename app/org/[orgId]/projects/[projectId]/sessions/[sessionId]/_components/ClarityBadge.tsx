...
import type { ClarityLabel } from '@/types/aiClarity'
  ...
  if (onClick) {
    return (
      <button
        type="button"
        onClick={onClick}
        className={cn('inline-flex items-center gap-1 rounded focus:outline-none focus:ring-2 focus:ring-primary/40', className)}
