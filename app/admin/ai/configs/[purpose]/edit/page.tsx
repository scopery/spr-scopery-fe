...
import { getProblemToastMessage, getProblemRequestId, getFieldErrors } from '@/shared/lib/errorHandling'
import type { AiConfigUpdateRequest, AiPurpose, AiEngineType } from '@/types/ai'
...
export default function EditAiConfigPage() {
  ...
  const handleSave = async () => {
    ...
    setIsSaving(true)
    try {
      await adminAiService.updateAiConfig(purpose, formData)
      ...
      <div className="space-y-6 rounded-lg border border-neutral-200 bg-white p-6">
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(v: string) => setFormData({ ...formData, primary_engine: v as AiEngineType })}
            options={[
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(v: string) => setFormData({ ...formData, fallback_engine: v ? (v as AiEngineType) : null })}
            options={[
        ...
        {formData.primary_engine === 'workflow_api' && (
          <div>
            ...
            {fieldErrors.workflow_id && (
              <Typography variant="xs" className="mt-1 text-error-600">
                {fieldErrors.workflow_id}
              </Typography>
            )}
            <Typography variant="xs" className="mt-1 text-neutral-500">
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, temperature: e.target.value ? Number(e.target.value) : null })
            }
            placeholder="0.0 - 1.0"
          />
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, timeout_ms: e.target.value ? Number(e.target.value) : null })
            }
