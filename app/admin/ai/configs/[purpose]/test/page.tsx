...
import { testRunAiConfig } from '@/services/admin-ai.service'
import { getProblemToastMessage, getProblemRequestId } from '@/shared/lib/errorHandling'
import type { AiPurpose, AiTestRunResponse } from '@/types/ai'
          ...
          {result && (
            <div className="rounded-lg border border-success-200 bg-success-50 p-6">
              <div className="mb-4 flex items-center justify-between">
                <Typography variant="lg" className="font-semibold text-success-900">
                  Test Run Succeeded
                </Typography>
              ...
              <div className="space-y-3">
                <div>
                  <Typography variant="xs" className="mb-1 font-semibold text-success-700 uppercase">
                    Engine Used
                  </Typography>
                  <Badge variant="neutral">{ENGINE_LABELS[result.engine_used] || result.engine_used}</Badge>
                </div>
                ...
                <div>
                  ...
                  <Typography variant="xs" className="font-mono text-success-900">
                    {result.run_id}
                  </Typography>
                </div>

                <div>
                  <Typography variant="xs" className="mb-2 font-semibold text-success-700 uppercase">
                    Output
                  </Typography>
          ...
          {error && (
            <div className="rounded-lg border border-error-200 bg-error-50 p-6">
              ...
              <div className="rounded-md bg-white p-3">
                <pre className="whitespace-pre-wrap text-sm text-error-900">{error}</pre>
              </div>
            </div>
          )}
