  ...
  if (isTodo) {
    ...
    return (
      ...
      >
        ...
        />
        <div className={cn('min-w-0 flex-1', checkboxProps.checked && 'text-neutral-500 line-through')}>
          {props.children}
        </div>
      </PlateElement>
    )
...
export function H1Element(props: PlateElementProps) {
  return (
    <PlateElement as="h1" className="mb-3 mt-4 text-2xl font-bold first:mt-0" {...props} />
  )
}

export function H2Element(props: PlateElementProps) {
  return (
    <PlateElement as="h2" className="mb-2 mt-3 text-xl font-semibold first:mt-0" {...props} />
  )
}

export function H3Element(props: PlateElementProps) {
  return (
    <PlateElement as="h3" className="mb-2 mt-3 text-lg font-semibold first:mt-0" {...props} />
  )
}
...
export function TableCellElement(props: PlateElementProps) {
  ...
  return (
    <PlateElement
      as="td"
      className={cn(
        'border border-neutral-200 p-2 align-top',
...
export function TableHeaderCellElement(props: PlateElementProps) {
  ...
  return (
    <PlateElement
      as="th"
      className={cn(
        'border border-neutral-200 bg-neutral-50 p-2 text-left font-semibold align-top',
