...
const mockSearch = vi.mocked(deliverablesService.searchDeliverablePickerDocuments)
  ...
  beforeEach(() => {
    ...
    mockSearch
      .mockResolvedValueOnce({
        items: [{ id: 'd1', title: 'Doc 1', document_type: 'note', workflow_status: 'draft', status: 'active', updated_at: '', project_id: 'p1' }],
        total: 2,
      })
      .mockResolvedValueOnce({
        items: [{ id: 'd2', title: 'Doc 2', document_type: 'note', workflow_status: 'draft', status: 'active', updated_at: '', project_id: 'p1' }],
        total: 2,
      })
  })
