...
import type { DeliverableReadinessStatus } from '@/types/document-deliverable'
...
export function DeliverableReadinessBadge({ status, warningCount }: DeliverableReadinessBadgeProps) {
