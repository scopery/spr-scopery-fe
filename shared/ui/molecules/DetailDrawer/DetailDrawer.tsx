...
export function DetailDrawer({
  ...
  return createPortal(
    <div className={cn('drawer', className)}>
      ...
      <aside
        className={cn(
          'motion-drawer-panel fixed inset-y-0 right-0 z-[101] flex w-full flex-col border-l border-neutral-200 bg-surface-card shadow-xl',
      ...
      >
        <div className="sticky top-0 z-10 flex items-start justify-between gap-3 border-b border-neutral-200 bg-surface-card px-5 py-4">
        ...
        {footer ? (
          <div className="sticky bottom-0 z-10 border-t border-neutral-200 bg-surface-card px-5 py-3">
            {footer}
          </div>
        ) : null}
      </aside>
