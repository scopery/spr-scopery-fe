...
describe('FileMediaLibrary', () => {
  ...
  it('calls onAdd when add button is clicked', async () => {
    ...
    const onAdd = vi.fn()
    render(<FileMediaLibrary folder={mockFolder} onAdd={onAdd} />)
  ...
  it('calls onShare when share button is clicked', async () => {
    const user = userEvent.setup()
    const onShare = vi.fn()
    render(<FileMediaLibrary folder={mockFolder} onShare={onShare} />)
  ...
  it('renders action button when onAction is provided', () => {
    render(<FileMediaLibrary folder={mockFolder} onAction={() => {}} />)
  ...
  it('calls onAction when action button is clicked', async () => {
    ...
    render(<FileMediaLibrary folder={mockFolder} onAction={onAction} />)
  ...
  it('uses custom action label', () => {
    render(<FileMediaLibrary folder={mockFolder} actionLabel="View Files" onAction={() => {}} />)
    expect(screen.getByText('View Files')).toBeInTheDocument()
  })

  it('renders navigation buttons when provided', () => {
    render(<FileMediaLibrary folder={mockFolder} onPrevious={() => {}} onNext={() => {}} />)
  ...
  it('calls onPrevious when previous button is clicked', async () => {
    ...
    render(<FileMediaLibrary folder={mockFolder} onPrevious={onPrevious} />)
  ...
  it('calls onNext when next button is clicked', async () => {
    const user = userEvent.setup()
    const onNext = vi.fn()
    render(<FileMediaLibrary folder={mockFolder} onNext={onNext} />)
