...
import type {
  ...
  DocumentSuggestion,
  MentionableUser,
} from '../model/collaboration-types'
...
export async function acceptSuggestion(
  ...
  return apiClient.post(
    COLLABORATION_ENDPOINTS.acceptSuggestion(orgId, documentId, suggestionId) +
...
export async function rejectSuggestion(
  ...
  return apiClient.post(
    COLLABORATION_ENDPOINTS.rejectSuggestion(orgId, documentId, suggestionId) +
      projectQuery(projectId)
  )
}
