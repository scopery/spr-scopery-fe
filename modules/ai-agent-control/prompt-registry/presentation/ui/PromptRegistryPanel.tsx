  ...
  return (
    <Box className="space-y-4">
      <Typography
        as="div"
        variant="small"
        className="rounded border border-amber-200 bg-amber-50 p-3 text-amber-900 dark:border-amber-900 dark:bg-amber-950/30 dark:text-amber-100"
      >
      ...
      <div className="grid gap-3 md:grid-cols-2">
        ...
        {canManage ? (
          <div className="flex items-end">
            <Button
              variant="outline"
              onClick={() => panel.setShowCreateForm((v) => !v)}
              icon={!panel.showCreateForm ? <Plus size={16} /> : undefined}
            >
                  ...
                  <Card as="li" key={version.id} className="border-border p-2 text-sm">
                    ...
                    {version.system_prompt ? (
                      <Typography
                        ...
                        size="xs"
                        tone="muted"
                        className="mt-2 max-h-24 overflow-auto whitespace-pre-wrap"
                      >
                        {version.system_prompt}
                      </Typography>
                    ) : null}
