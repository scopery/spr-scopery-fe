...
export const GUIDE_ARTICLES: GuideArticle[] = [
  ...
  },
  {
    ...
    groupId: 'getting-started',
    title: 'End-to-end delivery flow',
    subtitle: 'A practical order of work across Plan → Scope → Quality → Control.',
    keywords: ['flow', 'process', 'delivery', 'e2e', 'workflow'],
    suggestedQuestions: ['What order should I work in?', 'Full project flow?'],
    steps: [
      {
        title: 'Staff the project',
        body: 'Create the project, open Directory, add members who will plan and execute.',
        uiHints: ['Directory'],
      },
      {
        title: 'Plan work',
      ...
      },
      {
        ...
        body: 'Set Scope, capture Requirements / Functions / Use Cases, check Traceability gaps.',
        uiHints: ['Scope', 'Requirements', 'Functions', 'Use Cases', 'Traceability'],
      },
      {
        title: 'Verify quality',
        body: 'Add Cases → run them in Runs → log Defects → gate Releases.',
        uiHints: ['Cases', 'Runs', 'Defects', 'Releases'],
      },
      {
        title: 'Control change',
        body: 'Use Baselines and Change Requests when the plan becomes the reference; track RAID and Decisions in parallel.',
        uiHints: ['Baselines', 'Change Requests', 'RAID', 'Decisions'],
      },
    ],
    relatedIds: ['plan-work-items', 'scope-traceability', 'quality-overview', 'control-baselines'],
  },
