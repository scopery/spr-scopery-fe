    ...
    <Stack direction="vertical" spacing="md" className="p-lg">
      ...
      {items.length === 0 ? (
        ...
        <ul className="divide-y divide-neutral-200 border border-neutral-200">
          {items.map((r) => (
            <li key={r.id} className="flex flex-col gap-sm p-md sm:flex-row sm:items-center sm:justify-between">
              <div>
              ...
              <div className="flex flex-wrap gap-xs">
                ...
                <Button size="sm" tone="error" variant="outline" onClick={() => void decide(r.id, 'REJECTED')}>
                  Reject
                </Button>
              </div>
            </li>
