  ...
  return (
    <div className="space-y-3">
        ...
        {fields.map((field, index) => (
          <li key={field.id}>
            <button
              ...
              className="flex w-full items-start gap-3 py-2.5 text-left hover:bg-neutral-50"
            >
      ...
      <Modal
        ...
        title="Mode matrix"
        size="full"
        actions={[{ label: 'Close', onClick: () => setOpen(false), variant: 'ghost' }]}
      >
        <ModeMatrixTable
          workspaceId={workspaceId}
          screenId={screenId}
