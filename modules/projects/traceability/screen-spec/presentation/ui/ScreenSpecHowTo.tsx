...
> = {
  ...
  validations:
    'Fields are grouped by component. Edit opens the field + rule editor (search field or component). Import JSON adds many rules at once.',
  processes:
...
export const SCREEN_SPEC_WORKFLOW_STEPS = [
  ...
  'To load many screens at once, use Import → Screens (Excel = shell, JSON = full spec). Then export from the inspector or Detail Design.',
]
