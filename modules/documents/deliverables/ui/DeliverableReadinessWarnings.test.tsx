...
import { DeliverableReadinessWarnings } from '@/modules/documents'
import type { DeliverableReadinessResult } from '@/modules/documents/deliverables'
...
describe('DeliverableReadinessWarnings', () => {
  ...
  it('renders blocking issues', () => {
    const blocked: DeliverableReadinessResult = {
      ...
      blocking_issues: [
        { code: 'document_set_required', message: 'Select at least one document.' },
      ],
