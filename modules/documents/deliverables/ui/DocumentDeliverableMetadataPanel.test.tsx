...
import { DocumentDeliverableMetadataPanel } from '@/modules/documents'
import * as deliverablesApi from '../api/deliverables.api'

vi.mock('../api/deliverables.api')

const mockGetMetadata = vi.mocked(deliverablesApi.getDocumentDeliverableMetadata)
const mockRefresh = vi.mocked(deliverablesApi.refreshDocumentDeliverableReadiness)
...
describe('DocumentDeliverableMetadataPanel', () => {
  ...
  it('returns null for non-generated documents', async () => {
    ...
    const { container } = render(
      <DocumentDeliverableMetadataPanel orgId="org-1" documentId="doc-1" projectId="proj-1" />
    )
