...
import { PlateElement, useComposedRef, useEditorRef, type PlateElementProps } from 'platejs/react'
...
export function SlashCommandMenu(props: PlateElementProps<TComboboxInputElement>) {
  ...
  const commandGroups = useMemo(() => [...SLASH_COMMAND_GROUPS, ...extraGroups], [extraGroups])
