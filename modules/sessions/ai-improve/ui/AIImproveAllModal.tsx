            ...
            {openItems.length === 0 ? (
              ...
              <>
                ...
                <div className="flex justify-end gap-2 pt-2">
                  ...
                  >
                    {generating
                      ? `Generating… (${items.filter((i) => i.status === 'generated' || i.status === 'generating').length}/${openItems.length})`
                      : `Generate for all (${openItems.length})`}
                  </Button>
                </div>
              </>
            )}
                ...
                return (
                  ...
                  >
                    ...
                    <Typography variant="small" tone="muted" className="mb-2">
                      Current:{' '}
                      {formatValuePreview(currentAnswer?.value, question.q_type).slice(0, 80)}
