...
export async function listJoinRequests(
  ...
  return apiClient.get<JoinRequest[]>(JOIN_REQUEST_ENDPOINTS.list(workspaceId, params))
}
...
export async function rejectJoinRequest(
  ...
  return apiClient.patch<JoinRequest>(
    JOIN_REQUEST_ENDPOINTS.reject(workspaceId, requestId),
    body ?? {}
  )
}
...
export async function cancelJoinRequest(
  ...
  return apiClient.delete<JoinRequest>(JOIN_REQUEST_ENDPOINTS.cancel(workspaceId, requestId))
}
