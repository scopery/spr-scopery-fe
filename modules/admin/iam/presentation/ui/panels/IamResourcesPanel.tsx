...
import { Button, Input, Stack, Typography, Skeleton, DataTable } from '@/shared/ui'
    ...
    <Stack direction="vertical" spacing="md">
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto border border-neutral-200">
          <DataTable
            ariaLabel="Iam Resources Panel"
            rows={items}
            rowKey={(resource) => String(resource.id)}
            ...
            columns={[
              ...
              { id: 'type', header: 'Type', accessor: 'resourceType' },
              {
                id: 'name',
                header: 'Name',
                cell: (resource) => (
                  ...
                  <>
                    <Stack direction="horizontal" spacing="xs">
                      <Button
                        ...
                        onClick={() => void runAction(resource.id, 'activate')}
                        icon={<Check size={16} />}
                      >
                        Activate
                      </Button>
                      <Button
                        variant="ghost"
                        disabled={actingId === resource.id}
                        onClick={() => void runAction(resource.id, 'deactivate')}
                        icon={<Ban size={16} />}
                      >
                        Deactivate
                      </Button>
