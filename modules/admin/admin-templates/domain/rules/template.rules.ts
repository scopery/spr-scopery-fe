import type { SystemQuestion } from '../model/template'
...
export function questionsBySection(questions: SystemQuestion[]) {
  ...
  return sorted.reduce(
    ...
    {} as Record<string, SystemQuestion[]>
  )
}

export function orderedSectionEntries(
  bySection: Record<string, SystemQuestion[]>
