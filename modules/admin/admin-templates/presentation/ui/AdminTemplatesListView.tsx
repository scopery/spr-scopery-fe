...
import { CircleArrowOutUpLeft, Copy, Eye, Pencil, Plus } from 'lucide-react'
import { Typography, Button, Badge, Spinner, Select, Input, PageSkeleton } from '@/shared/ui'
...
export function AdminTemplatesListView() {
          ...
          <table className="w-full text-left">
            <thead className="border-b border-neutral-200">
              <tr>
                ...
                <th className="min-w-[16rem] whitespace-nowrap px-4 py-3 text-sm font-normal text-neutral-700">Actions</th>
              </tr>
            </thead>
            <tbody>
              {filtered.length === 0 ? (
                ...
                filtered.map((t) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <Badge tone={statusBadgeTone(t.status)}>
                        {t.status}
                      </Badge>
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-nowrap items-center gap-1">
                        <Button
                          ...
                          className="gap-1"
                          aria-label="View template" icon={<Eye size={16} />}>
                          <Eye size={14} />
                          View
                        </Button>
                        {t.status === 'draft' && (
