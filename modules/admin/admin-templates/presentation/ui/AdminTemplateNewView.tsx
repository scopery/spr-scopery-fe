...
import { createTemplate } from '../../infrastructure/api/admin-templates.api'
import { toast } from 'sonner'
import { getProblemToastMessage, getFieldErrors } from '@/shared/lib/errorHandling'

export function AdminTemplateNewView() {
    ...
    <div className="mx-auto max-w-lg p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex gap-2 pt-2">
          <Button type="submit" variant="primary" loading={loading} icon={<Plus size={16} />}>
            Create draft
          </Button>
