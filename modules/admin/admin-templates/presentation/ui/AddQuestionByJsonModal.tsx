...
import { Copy, FileJson, Plus, Upload } from 'lucide-react'
        ...
        {jsonTab === 'template' && (
          <div className="max-h-[50vh] space-y-4 overflow-y-auto">
            <div className="space-y-2">
              ...
              <Typography as="ul" variant="small" tone="muted" className="list-inside list-disc space-y-1">
                <li>
            ...
            <div>
              <div className="mb-1 flex items-center justify-between">
                ...
                <Button variant="ghost" onClick={handleCopySample} className="gap-1">
                  {copied ? (
                    'Copied'
                  ) : (
                    <>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="mb-2 flex gap-2">
                <Button
                  ...
                  className="gap-1" icon={<Upload size={16} />}>
                  <FileJson size={14} />
                  Upload .json
                </Button>
              </div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                loading={loading}
                disabled={!jsonInput.trim()} icon={<Plus size={16} />}>
                Add question(s)
              </Button>
            </div>
          </div>
