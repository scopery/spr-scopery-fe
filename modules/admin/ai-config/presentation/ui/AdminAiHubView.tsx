...
export function AdminAiHubView() {
  ...
  return (
    <div className="container mx-auto p-8">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Button variant="outline" onClick={() => router.push('/admin/ai/runs')} icon={<Eye size={16} />}>
          View Audit Logs
        </Button>
      </div>
          ...
          >
            <div className="mb-4 flex items-start justify-between">
              ...
              <div className="flex gap-2">
                <Button
                  variant="outline"
                  onClick={() => router.push(`/admin/ai/configs/${config.purpose}/edit`)} icon={<Pencil size={16} />}>
                  Edit
                </Button>
                <Button
                  variant="outline"
                  onClick={() => router.push(`/admin/ai/configs/${config.purpose}/test`)} icon={<Play size={16} />}>
                  Test Run
                </Button>
              </div>
            </div>
