...
import { testRunAiConfig } from '../../infrastructure/api/admin-ai.api'
import { getProblemToastMessage, getProblemRequestId } from '@/shared/lib/errorHandling'
import type { AiPurpose, AiTestRunResponse } from '../../domain/model/ai'
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-neutral-200 bg-white p-6">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <Button onClick={handleTestRun} isLoading={isRunning} icon={<Play size={16} />}>
                Run Test
              </Button>
            </div>
          ...
          {result && (
            <div className="border-success-200 bg-success-50 rounded-lg border p-6">
              ...
              <div className="mt-4 flex justify-end">
                <Button
                  variant="outline"
                  onClick={() => router.push(`/admin/ai/runs/${result.run_id}`)} icon={<Eye size={16} />}>
                  View Run Details
                </Button>
              </div>
            </div>
