  ...
  return (
    <div className="container mx-auto max-w-5xl p-8">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Button variant="outline" onClick={() => router.push('/admin/ai/runs')} icon={<ArrowLeft size={16} />}>
          Back to Runs
        </Button>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-6">
          <div className="mb-4 flex items-center gap-3">
            ...
            <Badge variant={STATUS_COLORS[run.status]}>
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-6">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Button variant="ghost" onClick={() => setShowPayload(!showPayload)} icon={<Eye size={16} />}>
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-6">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Button variant="ghost" onClick={() => setShowOutput(!showOutput)} icon={<Eye size={16} />}>
