...
import type { AIGeneratedBadgeProps } from '../../domain/model/ai-document-intelligence'
...
export function originLabel(originType?: DocumentOriginType | null): string {
  if (!originType) return 'Unknown origin'
