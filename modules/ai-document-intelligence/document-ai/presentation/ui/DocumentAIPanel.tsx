...
import type { DocumentAIPanelProps } from '../../domain/model/ai-document-intelligence'
import { AIGeneratedBadge, originLabel } from './AIGeneratedBadge'
import { AIPreviewDialog } from './AIPreviewDialog'
import { RelatedDocumentsPanel } from '@/modules/ai-document-intelligence/related-documents'
      ...
      {(generatedByAI || originType) && (
        <div className="space-y-2 border border-neutral-200 bg-white p-4">
          ...
          {permissions.canViewAIMetadata && (
            <Button variant="ghost" onClick={panel.loadMetadata} icon={<Eye size={16} />}>
              Show AI metadata
            </Button>
          )}
