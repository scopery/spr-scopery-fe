...
import type { ProjectAIActionsMenuProps } from '@/modules/ai-document-intelligence/document-ai'
import { AIPreviewDialog } from '@/modules/ai-document-intelligence/document-ai'
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-2">
          {permissions.canGenerateProjectBrief && (
            <Button variant="ghost" className="justify-start" onClick={() => void menu.runProjectBrief()} icon={<Sparkles size={16} />}>
              Generate project brief
            </Button>
          )}
          {permissions.canSummarizeProjectDocuments && (
            <Button variant="ghost" className="justify-start" onClick={() => void menu.runSummarizeDocuments()} icon={<Sparkles size={16} />}>
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button
              ...
              onClick={() => void menu.runSessionReport()} icon={<Plus size={16} />}>
              Create document
            </Button>
          </div>
        </div>
