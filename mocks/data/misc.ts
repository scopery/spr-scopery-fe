...
export const MOCK_EFFECTIVE_PERMISSIONS = {
  ...
  data: {
    permissions: [
      'workspace.view', 'workspace.update', 'workspace.manage_members',
      'workspace.manage_templates', 'workspace.manage_settings',
      'project.view', 'project.create', 'project.update', 'project.archive',
      'project.manage_members', 'project.manage_documents', 'project.manage_sections',
      'document.view', 'document.create', 'document.update', 'document.archive',
      'document.attach_to_project', 'document.pin', 'document.move_section',
      'document.create_from_template', 'document.export',
      'document.link.view', 'document.link.create', 'document.link.delete',
      'document.comment.view', 'document.comment.create', 'document.comment.resolve',
      'document.suggestion.view', 'document.suggestion.create',
      'document.suggestion.accept', 'document.suggestion.reject',
      'document.share_internal', 'document.manage_collaborators',
      'document.activity.view', 'document.view_ai_metadata',
      'template.view', 'template.create', 'template.update', 'template.archive',
      'template.duplicate', 'template.variable.view', 'template.variable.insert',
      'ai.generate_questions', 'ai.assess_clarity', 'ai.view_readiness',
      'ai.generate_document', 'ai.summarize_document',
      'document_hub.view', 'document_hub.search', 'document_hub.filter',
      'document_hub.view_workspace', 'document_hub.view_project',
      'governance.view', 'governance.manage', 'governance.evaluate',
      'agent_control.view', 'agent_control.manage',
      'prompt_registry.view', 'prompt_registry.manage',
      'agent_runtime.view', 'ai_usage.view', 'user.mention',
    ],
    roles: ['owner'],
    org_role: 'owner',
    project_role: 'editor',
...
export const MOCK_CONTROLLED_LIST_DETAIL = {
  ...
  values: [
    ...
    { id: 'mock-val-002', value: 'technical', label: 'Technical Design', position: 1, active: true },
