...
import type { EffectivePermissions, PermissionKey } from '@/types/permissions'
import { PERMISSIONS } from '@/types/permissions'
import type { ProfileStatus } from '@/types/api-enums'
...
export function resolveProjectRole(myRole: 'editor' | 'viewer' | undefined | null): 'editor' | 'viewer' {
...
export function buildDocumentSpacePermissions(
  ...
  return {
    ...
    canExportDocuments: effective
      ? hasPermission(effective, PERMISSIONS.DOCUMENT_EXPORT)
      : true,
  }
}
